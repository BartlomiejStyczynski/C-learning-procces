...
namespace StackOverflow
{
    ...
    public class Post
    {
        ...
        public void ArticTitle(string title)
        {
            this.Title = title;

        }
        public void Describtion(string describtion)
        {
            if(describtion.Length >= 300)
            this._descibtion = describtion.Substring(0, 300);

            this._wholeText = describtion;
