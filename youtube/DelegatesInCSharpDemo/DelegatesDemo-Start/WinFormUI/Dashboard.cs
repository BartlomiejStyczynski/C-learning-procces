...
namespace WinFormUI
{
    public partial class Dashboard : Form
    {
        ...
        {
            MessageBox.Show($"Sub total is {subTotal}:C2");
        }

        private decimal CalculateLeveledDiscount(List<ProductModel> productModels, decimal subTotal)
        {
            return subTotal - productModels.Count();
        }
    }
}
